...
export const EditVideoPage: React.FC<EditVideoPageProps> = ({
  ...
  const handleSave = () => {
    ...
    onSave({...video, description: fullPrompt});
  };
        ...
        <main>
          <div className="mb-6">
            ...
            <textarea
              ...
              aria-label={`Edit deskripsi untuk video`}
            />
          </div>
          <div className="mb-6">
            <label
            ...
            <textarea
              ...
              placeholder="misalnya, dalam gaya anime, buat hitam putih, tambahkan kucing"
              aria-label="Prompt tambahan untuk me-remix video"
            />
          </div>
        </main>
